					...
					<div class="row">
						<div class="col-md-3">
							<div class="card border-success">
								<div class="card-body">
									<?php echo form_open_multipart('backend/edit'); ?>
									<div class="mb-3">
										<label class="form-label">Tipe Kamar</label>
										<input type="hidden" name="kamar_id" class="form-control"
											value="<?= $editnya->kamar_id ?>">
										<select class="form-select" name="tipe_kamar"
											aria-label="Default select example">
											<option selected hidden>Open this select menu</option>
											<option value="Standard Room"
												<?php if ($editnya->tipe_kamar == 'Standard Room') echo 'selected="selected"' ?>>Standard Room</option>
											<option value="Connecting Rooms"
												<?php if ($editnya->tipe_kamar == 'Connecting Room') echo 'selected="selected"' ?>>Connecting Rooms</option>
											<option value="Deluxe Room"
												<?php if ($editnya->tipe_kamar == 'Deluxe Room') echo 'selected="selected"' ?>>Deluxe Room</option>
											<option value="Honeymoon Suite"
												<?php if ($editnya->tipe_kamar == 'Honeymoon Suite') echo 'selected="selected"' ?>>Honeymoon Suite</option>
											<option value="Presidental Suite"
												<?php if ($editnya->tipe_kamar == 'Presidental Suite') echo 'selected="selected"' ?>>Presidental Suite</option>
										</select>
									</div>
									<div class="mb-3">
										<label class="form-label">Jumlah Kamar</label>
										<input type="number" name="jumlah_kamar" class="form-control"
											value="<?= $editnya->jumlah_kamar ?>">
									</div>
									<div class="mb-3">
										...
										<?php foreach ($available_facilities as $facility): ?>
											<div class="form-check">
												<input class="form-check-input" type="checkbox" name="fasilitas_kamar[]"
													...
													<?php if (is_array($editnya->fasilitas_kamar) && in_array($facility['name'], $editnya->fasilitas_kamar)): ?>
													checked <?php endif; ?>>
									...
									<button type="" class="btn btn-danger"><a href="<?= base_url('backend') ?>"
