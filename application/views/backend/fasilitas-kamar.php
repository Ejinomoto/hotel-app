                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="card border-success">
                                    <div class="card-body">
                                        <?php echo form_open_multipart('froom/tambah'); ?>
                                        <div class="mb-3">
                                            <label class="form-label">Nama Fasilitas Kamar</label>
                                            <input type="text" name="name" class="form-control"
                                                placeholder="Masukan Fasilitas" required>
                                        </div>
                                                    ...
                                                    foreach ($row as $r): ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?= base_url('Froom/edit/' . $r->fasilitas_id) ?>"
                                                                    class="btn btn-sm btn-success">Edit</a>
                                                                <a href="<?= base_url('Froom/del/' . $r->fasilitas_id) ?>"
