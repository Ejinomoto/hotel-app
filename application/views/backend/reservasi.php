			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				<div class="app-brand demo">
					<a href="index.html" class="app-brand-link">
						...
						<span class="app-brand-text demo menu-text fw-bold">Resepsionis</span>
					</a>
			...
			<div class="layout-page">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="table-responsive text-nowrap">
										<table id="reservationsTable" class="dt-fixedcolumns table table-bordered">
											<thead>
											...
											<tbody>
												...
												foreach ($reservations as $r): ?>
													<tr class="text-center">
														...
														<td><?= $r->tipe_kamar; ?></td>
														<td><?= $r->kamar_id; ?></td>
														<td><?= date('d F Y', strtotime($r->check_in_date)); ?></td>
														<td><?= date('d F Y', strtotime($r->check_out_date)); ?></td>
														<td><?= $r->room_view; ?></td>
														<td><?= $r->room_floor; ?></td>
														<td><?= $r->notes; ?></td>
														<?php
														$check_in_date = new DateTime($r->check_in_date);
														$check_out_date = new DateTime($r->check_out_date);
														$interval = $check_in_date->diff($check_out_date);
														$total_days = $interval->days;
														?>

														<td><?= $total_days ?> days</td> <!-- Display Total Days -->
														...
														<td class="text-center">
															<div class="btn-group" role="group" aria-label="Action Buttons">
																<a href="<?= base_url('booking/accept/' . $r->reservation_id) ?>"
																	class="btn btn-sm btn-success">Accept</a>
																<a href="<?= base_url('booking/refuse/' . $r->reservation_id) ?>"
				...
				<script>
					$(document).ready(function() {
						...
						// Optional: Link your navbar search with the DataTables search
